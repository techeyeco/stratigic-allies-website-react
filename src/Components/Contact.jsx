  ...
  },
  {
    ...
    img: (
      <svg
        ...
        height="40"
        fill="currentColor"
        className={`bi bi-whatsapp fill-white ${transitionLarge}`}
        viewBox="0 0 16 16"
      >
  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto">
        ...
        <p className="text-white text-lg text-center mb-10 px-5 lg:md-0">
          ...
          <form className="flex flex-col itmes-center lg:px-0 gap-5">
            <div className="relative z-0 w-full ">
              <input
                ...
                name="floating_email"
                id="floating_email"
                className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-white appearance-none  focus:outline-none focus:ring-0 focus:border-white/70 peer"
                placeholder=" "
                required
              />
              <label
                htmlFor="floating_email"
                className="peer-focus:font-medium absolute text-sm text-white  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-white/70  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              >
                Email address
              </label>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div className="relative z-0 w-full group">
                ...
                <label
                  ...
                  className="peer-focus:font-medium absolute text-sm text-white  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-white/70  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                  Full Name
                </label>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 items-center justify-around gap-5">
            <div className="flex flex-col md:flex-row w-full items-center justify-evenly lg:justify-start lg:gap-5">
              ...
              <div className="grid grid-cols-1 justify-center items-center text-white">
                <p className="text-lg"> +964 774 055 25 25</p>
              </div>
            </div>
            <div className="flex flex-col md:flex-row w-full items-center justify-evenly lg:justify-start lg:gap-5">
              <div className="border p-2 rounded-full border-white">
