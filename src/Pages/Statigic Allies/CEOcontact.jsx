  ...
  const socialMediaItemsKBL = [
    {
      ...
      img: (
        <svg
          ...
          height="40"
          fill="currentColor"
          className="bi bi-linkedin fill-white hover:scale-110 duration-300 ease-in-out"
          viewBox="0 0 16 16"
        >
    ...
    },
    {
      ...
      img: (
        <svg
          ...
          height="40"
          fill="currentColor"
          className={`bi bi-facebook fill-white hover:scale-110 duration-300 ease-in-out`}
          viewBox="0 0 16 16"
        >
    ...
    },
    {
      ...
      img: (
        <svg
          ...
          height="40"
          fill="currentColor"
          className={`bi bi-instagram fill-white hover:scale-110 duration-300 ease-in-out`}
          viewBox="0 0 16 16"
        >
          ...
          <div className="bg-light p-20 overflow-hidden ">
            ...
            >
              <img
                src={book}
                alt=""
                className="w-96 mx-auto hover:scale-110 duration-300 ease-in-out"
              />
              <div className="">
                <p
